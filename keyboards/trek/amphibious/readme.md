...
Make example for this keyboard (after setting up your build environment):
    ...
    make trek/amphibious:default

Flashing example for this keyboard:

    make trek/amphibious:default:flash
...
* [trek_amphibious_jius-jp.uf2](trek_amphibious_jius-jp.uf2) — keymap `jius-jp` (JIS)
* [trek_amphibious_jius-us.uf2](trek_amphibious_jius-us.uf2) — keymap `jius-us` (US)
