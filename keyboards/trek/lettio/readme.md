...
Make example for this keyboard (after setting up your build environment):
    ...
    make trek/lettio:default

Flashing example for this keyboard:

    make trek/lettio:default:flash
...
* [trek_lettio_default.uf2](trek_lettio_default.uf2) — keymap `default`
* [trek_lettio_autolayer.uf2](trek_lettio_autolayer.uf2) — legacy build before HostOS (switches layers on OS detection instead)
