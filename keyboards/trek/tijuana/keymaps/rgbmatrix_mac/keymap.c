...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|----------------+--------+--------+----------------+----------------+-------------+--------------+--------+-------------+-------------+---------------+----------------+---------+--------+----------------|
                TG(1),                                                                           KC_P0, KC_PDOT, LT(2,KC_ENT),                                                                        LCTL(KC_D)
  //|----------------+--------+--------+----------------+----------------+-------------+--------------+--------+-------------+-------------+---------------+----------------+---------+--------+----------------|
  ),
  [1] = LAYOUT(
  //|----------------+--------+--------+----------------+----------------+-------------+--------------+--------+-------------+-------------+---------------+----------------+---------+--------+----------------|
  ...
  //|----------------+--------+--------+----------------+----------------+-------------+--------------+--------+-------------+-------------+---------------+----------------+---------+--------+----------------|
              _______, _______, _______,         _______,         _______,      _______,        KC_ESC,    KC_X,      KC_BSPC,      _______,        _______,         _______,  _______, _______,         _______,
  //|----------------+--------+--------+----------------+----------------+-------------+--------------+--------+-------------+-------------+---------------+----------------+---------+--------+----------------|
              _______, _______, _______,         _______,         _______,      _______,          KC_D,    KC_M,         KC_R,      _______,        _______,         _______,  _______, _______,         _______,
  //|----------------+--------+--------+----------------+----------------+-------------+--------------+--------+-------------+-------------+---------------+----------------+---------+--------+----------------|
                                                 _______,         _______,      _______, LGUI(KC_SLSH),    KC_E,         KC_W,      _______,        _______,         _______,
  //|----------------+--------+--------+----------------+----------------+-------------+--------------+--------+-------------+-------------+---------------+----------------+---------+--------+----------------|
                TG(1),                                                                         KC_LGUI,    KC_V,         KC_H,                                                                           _______
  //|----------------+--------+--------+----------------+----------------+-------------+--------------+--------+-------------+-------------+---------------+----------------+---------+--------+----------------|
  ),
  [2] = LAYOUT(
  //|----------------+--------+--------+----------------+----------------+-------------+--------------+--------+-------------+-------------+---------------+----------------+---------+--------+----------------|
  ...
  //|----------------+--------+--------+----------------+----------------+-------------+--------------+--------+-------------+-------------+---------------+----------------+---------+--------+----------------|
            LSG(KC_4), _______, _______,         _______,         _______,      _______,       _______,   KC_UP,      _______,      KC_LEFT,        KC_DOWN,           KC_UP, KC_RIGHT, _______,         KC_BSLS,
  //|----------------+--------+--------+----------------+----------------+-------------+--------------+--------+-------------+-------------+---------------+----------------+---------+--------+----------------|
              _______, _______, _______,         _______,       LSG(KC_V),      _______,       KC_LEFT, _______,      KC_RGHT,      _______,  LGUI(KC_LBRC),   LGUI(KC_RBRC),  KC_LBRC, KC_RBRC,         _______,
  //|----------------+--------+--------+----------------+----------------+-------------+--------------+--------+-------------+-------------+---------------+----------------+---------+--------+----------------|
                                                 _______,          KC_DEL,        MO(3),       _______, KC_DOWN,      _______,        MO(3),          KC_F2,         _______,
  //|----------------+--------+--------+----------------+----------------+-------------+--------------+--------+-------------+-------------+---------------+----------------+---------+--------+----------------|
              _______,                                                                         KC_BSPC, KC_COMM,      _______,                                                                           _______
  //|----------------+--------+--------+----------------+----------------+-------------+--------------+--------+-------------+-------------+---------------+----------------+---------+--------+----------------|
  ),
  [3] = LAYOUT(
  //|----------------+--------+--------+----------------+----------------+-------------+--------------+--------+-------------+-------------+---------------+----------------+---------+--------+----------------|
