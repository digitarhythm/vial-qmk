...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|----------------+--------+--------+----------------+----------------+-------------+--------------+--------+-------------+-------------+---------------+----------------+---------+--------+----------------|
                                         LALT_T(KC_LNG2), LCTL_T(KC_BSPC), LT(2,KC_SPC),         KC_P1,   KC_P2,        KC_P3, LT(2,KC_SPC), RCTL_T(KC_ENT), RCTL_T(KC_LNG1),
  //|----------------+--------+--------+----------------+----------------+-------------+--------------+--------+-------------+-------------+---------------+----------------+---------+--------+----------------|
  ...
  //|----------------+--------+--------+----------------+----------------+-------------+--------------+--------+-------------+-------------+---------------+----------------+---------+--------+----------------|
              _______, _______, _______,         _______,         _______,      _______,       _______,   KC_UP,      _______,      KC_LEFT,        KC_DOWN,           KC_UP, KC_RIGHT, _______,         KC_BSLS,
  //|----------------+--------+--------+----------------+----------------+-------------+--------------+--------+-------------+-------------+---------------+----------------+---------+--------+----------------|
              _______, _______, _______,         _______,      LGUI(KC_V),      _______,       KC_LEFT, _______,      KC_RGHT,      _______,  LGUI(KC_LBRC),   LGUI(KC_RBRC),  KC_LBRC, KC_RBRC,         _______,
  //|----------------+--------+--------+----------------+----------------+-------------+--------------+--------+-------------+-------------+---------------+----------------+---------+--------+----------------|
